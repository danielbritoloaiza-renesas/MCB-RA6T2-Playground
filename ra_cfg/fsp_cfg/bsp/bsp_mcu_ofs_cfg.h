...
#define BSP_CFG_OPTION_SETTING_OFS1_SEC_NO_HOCOFRQ  (0xFFF0F8F8 | (1 <<2) | (3) |  (1 << 8) | (0 << 16) | (0 << 17) | (0 << 18) | (0 << 19))
...
#define BSP_CFG_OPTION_SETTING_OFS1_SEC  ((uint32_t) BSP_CFG_OPTION_SETTING_OFS1_SEC_NO_HOCOFRQ | ((uint32_t) BSP_CFG_HOCO_FREQUENCY << BSP_FEATURE_BSP_OFS1_HOCOFRQ_OFFSET))
  ...
  #define BSP_CFG_OPTION_SETTING_OFS1_SEL  (4293982456 | ((0U << 0U)) | ((0U << 2U)) | ((BSP_CFG_CLOCKS_SECURE == 0) ? 0xF00 : 0U) | ((0U << 16U)) | ((0U << 17U)) | ((0U << 18U)) | ((0U << 19U)))
#else
#define BSP_CFG_OPTION_SETTING_OFS1_SEL  (4293982456)
#endif
#endif
